...
public class MenuOverlay {
    ...
    public void toggle() {
        ...
        if (visible && game.arcadeLoop != null && game.arcadeLoop.currentGameOrchestrator != null) {
            game.arcadeLoop.currentGameOrchestrator.paused = true;
        } else if (!visible && game.arcadeLoop != null && game.arcadeLoop.currentGameOrchestrator != null) {
            game.arcadeLoop.currentGameOrchestrator.paused = false;
        }
    }
