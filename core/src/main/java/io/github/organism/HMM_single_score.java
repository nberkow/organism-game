...
public class HMM_single_score implements Model  {

    /*
    uses one score per node to make transition/emission choices
    ...
    String model_type = "single";
    OrganismGame game;
    public HMM_single_score(OrganismGame g, int s, int n) {
        name = "bot";
        rng = game.rng;
