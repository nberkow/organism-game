...
public class HMM_mod1 implements Model  {

    /*
    Combines probabilities using mod 1 sum instead of
    log multiplication
     */
    ...
    String model_type = "mod1";
    OrganismGame game;
    public HMM_mod1(OrganismGame g, int s, int n) {
        name = "bot";
        rng = game.rng;
